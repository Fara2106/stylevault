/**
 * Icona a tratto sottile (stroke), coerente con lo stile editoriale.
 * Uso: <Icon name="hanger" size={20} />
 */
...
const PATHS = {
  ...
  sparkle: (
    <path d="M12 3l1.9 5.8 5.8 1.9-5.8 1.9L12 18.4l-1.9-5.8L4.3 11.6l5.8-1.9L12 3zM19 15l.7 2.1L21.8 18l-2.1.7L19 20.8l-.7-2.1-2.1-.7 2.1-.7L19 15z" />
  ),
  ...
  wind: (
    <path d="M9.59 4.59A2 2 0 1 1 11 8H2M17.73 7.73A2.5 2.5 0 1 1 19.5 12H2M12.59 19.41A2 2 0 1 0 14 16H2" />
  ),
